...
sleep 5
SDL_HINT_CUDA_DEVICE=1 ${CARLA_ROOT}/CarlaUE4.sh -carla-world-port=8030 -quality-level=Epic -resx=800 -resy=600 -opengl&
sleep 5
SDL_HINT_CUDA_DEVICE=1 ${CARLA_ROOT}/CarlaUE4.sh -carla-world-port=8040 -quality-level=Epic -resx=800 -resy=600 -opengl&
