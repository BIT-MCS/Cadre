...
class danet_config(basic_config):
    def __init__(self):
        ...
        # only when self.pred_bc is False
        ...
        if self.load_epoch == -1:
            ...
            self.optimizers['autoencoder']['pretrained_path'] = os.path.join(os.environ['CHALLENGE_DIR'],
                                                                             'carla_perception/Experiments' + self.exp_suffix,
                                                                             self.exp_dir,
                                                                             file_name)
