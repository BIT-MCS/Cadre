...
class da_beta_vae_config(basic_config):
    def __init__(self):
        ...
        self.test_opt['route_index'] = [504] #[21, 22, 23, 24] #[9] #[1]
        ...
        self.test_opt['root_dir'] = '/data2/wk/datasets/challenge_train_for_nocrash_test/train'
        # self.test_opt['route_name'] = 'route_' + str(self.test_opt['route_index'][0])[:-1]
        self.test_opt['route_name'] = 'route_' + str(self.test_opt['route_index'][0]).zfill(3)
        ...
        self.networks['autoencoder']['z_dims'] = 32 #128 #32 #10 #256 #64
