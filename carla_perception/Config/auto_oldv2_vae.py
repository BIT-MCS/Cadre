...
config['mixed_percision'] = False

config['pred_curSpeed'] = False
config['pred_tarSpeed'] = False
config['pred_topdown'] = True
...
networks['autoencoder']['model_name'] = 'oldv2-vae'
...
networks['autoencoder']['pred_curSpeed'] = config['pred_curSpeed']
networks['autoencoder']['pred_tarSpeed'] = config['pred_tarSpeed']
networks['autoencoder']['pred_topdown'] = config['pred_topdown']
...
optimizers['autoencoder']['lr'] = 0.0004
