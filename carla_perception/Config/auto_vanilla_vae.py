...
class vanilla_vae_config(basic_config):
    def __init__(self):
        ...
        self.output_mode = 9 #8 #5
        self.change_output_mode(self.output_mode)

        self.version = 'vanilla_vae'
        ...
        self.train_town = "nocrash_n10_k1234_r40" # "all"
        ...
        self.train_opt['root_dir'] = '/data2/wk/datasets/nocrash_n10_k1234_r40/train'
        ...
        self.test_opt['route_index'] = [5] #[9] #[1]
        ...
        self.test_opt['root_dir'] = '/data2/wk/datasets/nocrash_n10_k1234_r40/train'
        self.test_opt['route_name'] = 'route_' + str(self.test_opt['route_index'][0])
        ...
        self.networks['autoencoder']['model_name'] = 'vanilla-vae'
...
config = vanilla_vae_config()

# ############# Loss ###################
# # loss_funcs = dict()
# # loss_funcs['imgRecon_loss'] = "get_imgRecon_loss"
# # loss_funcs['lidarRecon_loss'] = "get_lidarRecon_loss"
# # if config['pred_topdown']:
# #     loss_funcs['topdownPred_loss'] = "get_topdownPred_loss"
# # if config['pred_curSpeed']:
# #     loss_funcs['curSpeed_loss'] = "get_curSpeed_loss"
# # if config['pred_tarSpeed']:
# #     loss_funcs['targetSpeed_loss'] = "get_targetSpeed_loss"
# # loss_funcs['lightState_loss'] = "get_lightState_loss"
# # loss_funcs['lightDist_loss'] = "get_lightDist_loss"
# # loss_funcs['kld_loss'] = "get_kld_loss"

# # config['loss_funcs'] = loss_funcs
