...
config['gpu_ids'] = [-1]#[0, 1, 2, 3] #default='-1', help='gpu ids: e.g. 0  0,1,2, 0,2. use -1 for CPU')
...
networks['autoencoder']['model_name'] = 'rcnn-attunet'
...
networks['autoencoder']['z_dims'] = 20
networks['autoencoder']['num_input'] = config['in_backbone']
