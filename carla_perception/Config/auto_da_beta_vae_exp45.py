...
class da_beta_vae_config(basic_config):
    def __init__(self):
        ...
        # 9: 1 center camera, route, bc_speed
        # 10: 1 center camera, bc_speed
        self.input_mode = 1 #5 #3
        ...
        # 13: last camera semantic, light state
        # 14: last camera semantic, light state, behviour cloning
        self.output_mode = 13 #8 #5
        self.change_output_mode(self.output_mode)

        self.version = 'da_beta_vae'
        ...
        self.train_opt['root_dir'] = '/data2/wk/datasets/nocrash_IL_n10_k1234_r40/train'
        ...
        self.test_opt['root_dir'] = '/data2/wk/datasets/nocrash_IL_n10_k1234_r40/train'
        # self.test_opt['route_name'] = 'route_' + str(self.test_opt['route_index'][0])[:-1]
        self.test_opt['route_name'] = 'all'
        ...
        self.networks['autoencoder']['model_name'] = 'da_beta_vae'
        ...
        self.networks['autoencoder']['z_dims'] = 32 #32 #10 #256 #64
        self.networks['autoencoder']['beta'] = 6
        #['transformer', 'position'] only when self.pred_bc is True
        self.networks['autoencoder']['att_type'] = 'position'
        self.networks['autoencoder']['da_feature_channel'] = 256 #128
        self.networks['autoencoder']['inter_att_dims'] = -1 #128
