...
class vanilla_vae_config(basic_config):
    def __init__(self):
        ...
        self.train_opt['root_dir'] = '/data2/wk/datasets/vae_challenge_n10_k123_r5/train'
        ...
        self.test_opt['route_index'] = [24] #[9] #[1]
        ...
        self.test_opt['root_dir'] = '/data2/wk/datasets/vae_challenge_n10_k123_r5/train'
