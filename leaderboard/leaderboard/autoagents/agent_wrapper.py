...
class AgentWrapper(object):
    ...
    def __call__(self, lp_wrapper):
        """
        Pass the call directly to the agent
        """
        return self._agent(lp_wrapper)

    def update_completion(self, completion):
        self._agent.update_completion(completion)
        ...
        for sensor_spec in self._agent.sensors():
            ...
            # These are the sensors spawned on the carla world
                ...
                if sensor_spec['type'].startswith('sensor.camera.rgb'):
                    ...
                    # todo: debug
                    bp.set_attribute('hit_radius', str(1.0))
    ...
    def validate_sensor_configuration(sensors, agent_track, selected_track):
        ...
        """
        # print("validate_sensor_configuration")
        # print(agent_track, Track(selected_track))
        # if Track(selected_track) != agent_track:
        #     print("rack(selected_track) != agent_track")
    ...
    def cleanup(self):
        ...
        self._agent.scenario = None
        self._agent.event_num = None
        self._agent.initialized = None

    def setup_scenarios(self, scenario):
        """
        setup scenarios
        initialize event numbers
        """
        self._agent.scenario = scenario
        self._agent.event_num = np.zeros(7)
        self._agent.initialized = False

    def get_episode(self):
        return self._agent.get_episode()