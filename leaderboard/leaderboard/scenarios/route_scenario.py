...
class RouteScenario(BasicScenario):
    ...
    def __init__(self, st, ed, world, config, debug_mode=0, criteria_enable=True, log_file=None):
        """
    ...
    def _update_route(self, st, ed, world, config, debug_mode):
        ...
        potential_scenarios_definitions, _, _ = RouteParser.scan_route_for_scenarios(
    ...
    def _initialize_actors(self, config):
        ...
        if self.vehicle_amount > 0:
            self.vehicle_amount = town_amount.get(config.town, 0)
