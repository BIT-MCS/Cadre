...
class ResultOutputProvider(object):
    ...
    def __init__(self, data, global_result, file_name):
        """
    ...
    def save_result(self, file_name):
        ...
        for criterion in self._data.scenario.get_criteria():
            ...
            result_str = result + ": "
            result_list.append(actual_value)
            result_str = result_str + ", [" + name + ": " + str(actual_value) + "] "
    ...
    def create_output_text(self):
        ...
        output += tabulate(list_statistics)
        output += "\n\n"
