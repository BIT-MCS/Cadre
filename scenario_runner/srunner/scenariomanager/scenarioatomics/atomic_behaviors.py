            ...
            if actor is not None and actor.is_alive and local_planner is not None:
                ...
                # The walker is sent to the next waypoint in its plan
                    ...
                    if self._actor_dict[actor]:
                        ...
                        # todo:
                        print('3 direction is ', control.direction)
...
class TrafficLightManipulator(AtomicBehavior):
    ...
    RED_TIME = 0.1  # Minimum time the ego vehicle waits in red (seconds)
    ...
    def get_waiting_time(self, annotation, direction):
        ...
        # print('waiting time is ', self.RED_TIME + distance * self.DIST_TO_WAITING_TIME)
...
class ScenarioTriggerer(AtomicBehavior):
    ...
    def update(self):
        ...
        for black_var_name, scen_location in self._blackboard_list:
            ...
            # if not condition1 and condition2 and not condition3:
            if condition2 and not condition3:
                already_done_num += 1
            # condition4 = bool(len(self._triggered_scenarios) == self.done_scenario)
        ...
        self.done_scenario = max(self.done_scenario, already_done_num)
        return new_status
