...
#         self._first_vehicle_location = 2
...
#         self.first_vehicle_transform = None
...
#         self.first_vehicle_transform = first_vehicle_transform
#         # todo: change
#         world_actors = np.random.choice(CarlaDataProvider._blueprint_library.filter('vehicle.*'))
#         # first_vehicle = CarlaDataProvider.request_new_actor('vehicle.nissan.patrol', first_vehicle_transform)
#         first_vehicle = CarlaDataProvider.request_new_actor(world_actors.id, first_vehicle_transform)
...
#         success_condition = py_trees.composites.Parallel("Waiting for success",
#                                                          policy=py_trees.common.ParallelPolicy.SUCCESS_ON_ONE)
#         # endcondition = py_trees.composites.Parallel("Waiting for end position",
#         #                                             policy=py_trees.common.ParallelPolicy.SUCCESS_ON_ONE)
...
#         #                                                 distance=20,
#         #                                                 name="FinalDistance")
#         # standstill = StandStill(self.other_actors[0], name="followleadingvehicle", duration=6)
#
#
#
#         # sequence1.add_child(Rectify(self.status, "running", name="followleadingvehicle"))
#         # sequence1.add_child(standstill)
#         # sequence1.add_child(Rectify(self.status, "success", name="followleadingvehicle"))
#
#         sequence2 = py_trees.composites.Sequence("Sequence Behavior")
#         has_been_occupied = HasBeenOccupied(self.ego_vehicles[0], self.other_actors[0], name="HasBeenOccupied")
#         sequence2.add_child(has_been_occupied)
#         sequence2.add_child(Rectify(self.status, "finished", name="followleadingvehicle"))
#
#         sequence3 = py_trees.composites.Parallel("Waiting for success",
#                                                          policy=py_trees.common.ParallelPolicy.SUCCESS_ON_ONE)
#         sequence3.add_child(StandStill(self.other_actors[0], name="followleadingvehicle", duration=6))
#         sequence3.add_child(TooFarAway(self.other_actors[0], self.other_actors[0], name="TooFarAway"))
#
#         # Build behavior tree
#         sequence1 = py_trees.composites.Sequence("Sequence Behavior")
#         sequence1.add_child(start_transform)
#         sequence1.add_child(sequence3)
#
#         success_condition.add_child(sequence1)
#         success_condition.add_child(sequence2)
#
#         full_condition = py_trees.composites.Sequence("Sequence Behavior")
#         full_condition.add_child(success_condition)
#         # full_condition.add_child(ActorDestroy(self.other_actors[0]))
#         full_condition.add_child(
#             ActorTransformSetter(self.other_actors[0], self.first_vehicle_transform, name='Followleadingvehicles'))
#
#         # return sequence
...
class FollowLeadingVehicle(BasicScenario):
    ...
    def _create_behavior(self):
        ...
        # sequence3.add_child(TooFarAway(self.ego_vehicles[0], self.other_actors[0], name="TooFarAway"))

        # Build behavior tree
        sequence1 = py_trees.composites.Sequence("Sequence Behavior")
        sequence1.add_child(start_transform)
        sequence1.add_child(StandStill(self.other_actors[0], name="followleadingvehicle", duration=6))
...
class FollowLeadingVehicleWithObstacle(BasicScenario):
    ...
    def _initialize_actors(self, config):
        ...
        second_actor = CarlaDataProvider.request_new_actor(
            ...
            'vehicle.tesla.model3', second_actor_transform)
