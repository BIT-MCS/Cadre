        ...
        while True:
            ...
            try:
                ...
                first_vehicle = CarlaDataProvider.request_new_actor(
                    ...
                    'vehicle.tesla.model3', self._other_actor_transform)
            ...
            # Move the spawning point a bit and try again
                ...
                print('in object_crash_intersection-1')
    ...
    def _initialize_actors(self, config):
        ...
        while True:
            ...
            # Move the spawning point a bit and try again
                ...
                # In the case there is an object just move a little bit and retry
                print('in object_crash_intersection-2')
                print(" Base transform is blocking objects ", self._other_actor_transform)
                added_dist += 0.5
                self._spawn_attempted += 1
                if self._spawn_attempted >= self._number_of_attempts:
...
#         Setup all relevant parameters and create scenario
#         """
#         print('has a vehicle turning route')
#         self._other_actor_target_velocity = 10
#         self._wmap = CarlaDataProvider.get_map()
#         self._reference_waypoint = self._wmap.get_waypoint(config.trigger_points[0].location)
#         self._trigger_location = config.trigger_points[0].location
...
#                 self._spawn_attempted += 1
#                 if self._spawn_attempted >= self._number_of_attempts:
#                     # print("self._spawn_attempted >= self._number_of_attempts")
#                     raise r
#
#         # Set the transform to -500 z after we are able to spawn it
#         actor_transform = carla.Transform(
...
#
#
#         vehicle_scenario = py_trees.composites.Parallel(
#             "stop vehicle",
#             policy=py_trees.common.ParallelPolicy.SUCCESS_ON_ONE)
#         vehicle_run = py_trees.composites.Sequence()
#         vehicle_run.add_child(HandBrakeVehicle(self.other_actors[0], False))
#         vehicle_run.add_child(actor_ego_sync)
#         vehicle_run.add_child(after_timer_actor)
#         vehicle_scenario.add_child(vehicle_run)
#         vehicle_scenario.add_child(end_condition)
#         scenario_sequence.add_child(vehicle_scenario)
#
#         # scenario_sequence.add_child(HandBrakeVehicle(self.other_actors[0], False))
#         # scenario_sequence.add_child(actor_ego_sync)
#         # scenario_sequence.add_child(after_timer_actor)
