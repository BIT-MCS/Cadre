...
class DynamicObjectCrossing(BasicScenario):
    ...
    def _create_behavior(self):
        ...
        scenario_sequence1 = py_trees.composites.Sequence()
        scenario_sequence1.add_child(ActorTransformSetter(self.other_actors[0], self.transform,
                                                         name='TransformSetterTS3walker', physics=False))
        scenario_sequence1.add_child(ActorTransformSetter(self.other_actors[1], self.transform2,
                                                         name='TransformSetterTS3coca', physics=False))

        scenario_sequence2 = py_trees.composites.Sequence()
        scenario_sequence2.add_child(HandBrakeVehicle(self.other_actors[0], True))
        scenario_sequence2.add_child(start_condition)
        scenario_sequence2.add_child(HandBrakeVehicle(self.other_actors[0], False))
        ...
        scenario_sequence2.add_child(ActorTransformSetter(self.other_actors[0], self._disp_transform,
                                                         name='TransformSetterTS3walker', physics=False))
        scenario_sequence2.add_child(ActorTransformSetter(self.other_actors[1], self._prop_disp_transform,
                                                         name='TransformSetterTS3coca', physics=False))
        # scenario_sequence.add_child(actor_remove)
        # scenario_sequence.add_child(static_remove)
        scenario_sequence2.add_child(end_condition)

        scenario_sequence3 = py_trees.composites.Parallel(
            policy=py_trees.common.ParallelPolicy.SUCCESS_ON_ONE, name="reset scenario by detect ego vehicle's position")
        scenario_sequence3.add_child(scenario_sequence2)
        scenario_sequence3.add_child(TooFarAway(self.ego_vehicles[0], self.other_actors[1], name="TooFarAway"))
        scenario_sequence.add_child(scenario_sequence1)
        scenario_sequence.add_child(scenario_sequence3)
        scenario_sequence.add_child(ActorTransformSetter(self.other_actors[0], self._disp_transform,
                                                         name='TransformSetterTS3walker', physics=False))
        scenario_sequence.add_child(ActorTransformSetter(self.other_actors[1], self._prop_disp_transform,
                                                         name='TransformSetterTS3coca', physics=False))
